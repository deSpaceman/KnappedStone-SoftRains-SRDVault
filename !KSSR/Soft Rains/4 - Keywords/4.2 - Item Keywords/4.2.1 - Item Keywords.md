...
**Repair Tool**: This tool can be used to repair Structures, Vehicles and items with the Damaged X or Broken Keywords without the need to roll. Having an item with this
...
**Reach**: Melee attacks done by this weapon can reach an additional Movement Space.

**Sweeping**: Melee attacks done by this weapon can cover a 3 Movement Spaces horizontal line whose center is the space right in front of the user. For a better frame of reference, check the diagrams under this description.
...
**Straight Path**: Projectiles shot from this weapon hardly deviate from their trajectory. When shooting against a target that is standing still, gain Advantage 2.
